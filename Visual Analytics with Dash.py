...
def get_scatter_chart(entered_site, payload):
    filtered_df_2 = spacex_df[spacex_df['Payload Mass (kg)'].between(payload[0],payload[1])]
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df_2, x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig
    else:
        fig = px.scatter(filtered_df_2[filtered_df_2['Launch Site']==entered_site], x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig
# Run the app
